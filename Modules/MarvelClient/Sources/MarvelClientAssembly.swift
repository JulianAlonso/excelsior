...
public final class MarvelClientAssembly{
    ...
    public lazy var characterService: CharacterServicing = CharacterService(client: client)
    public lazy var characterProvider: CharacterProviding = CharacterProvider(service: characterService)
}
